...
bildneutral = pygame.image.load("Arsenneutral.png").convert_alpha()
img2 = pygame.image.load("Arsenhappy.png").convert_alpha()
img3 = pygame.image.load("Arsensad.png").convert_alpha()
img4 = pygame.image.load("Arsenspeaking.png").convert_alpha()
